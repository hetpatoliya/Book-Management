...
export class authorService {
    ...
    public async updateAuthor(author: Iauthor, authorId: String, adminId: String): Promise<String> {
        ...
        isAuthor = await Author.findOneAndUpdate({ _id: authorId }, { $set: { name: author.name, biography: author.biography, nationality: author.nationality, updatedBy: adminId } }, { new: true })
